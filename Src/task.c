...
void kirim_lcd(void)
{
	...
	if(lapA<totlap){
			...
			lcd_send_string(buffer);
			lcd_send_cmd(0xc0);
			sprintf(buffer,"TrackA%d=%d%d:%d%d:%d%d",(lapA),(mm1/10),(mm1%10),(dd1/10),(dd1%10),(ms/10),(ms%10));
			lcd_send_string(buffer);
	...
	if(lapB<totlap){
				...
				lcd_send_string(buffer);
				lcd_send_cmd(0x94);
				sprintf(buffer,"TrackB%d=%d%d:%d%d:%d%d",(lapB),(mm1/10),(mm1%10),(dd1/10),(dd1%10),(ms/10),(ms%10));
				lcd_send_string(buffer);
	...
	if(lapC<totlap){
				...
				lcd_send_string(buffer);
				lcd_send_cmd(0xd4);
				sprintf(buffer,"TrackC%d=%d%d:%d%d:%d%d",(lapC),(mm1/10),(mm1%10),(dd1/10),(dd1%10),(ms/10),(ms%10));
				lcd_send_string(buffer);
